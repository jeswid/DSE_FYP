...
"""
This script is the implementation of the vAE encoder, VAE decoder, and 
the overall VAE architecture following Semenova et al. (2023). The original codes
can also be obtained from Semenova et al. (2023)'s Github page (listed within the paper which was cited in the references section of the report)
